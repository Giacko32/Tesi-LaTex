...
\newcommand{\myTitle}{Tecniche di AML per la generazione di attacchi query efficient}
\newcommand{\myAuthor}{Giuseppe Ganci}
...
%*********************************************************************************
\newcommand{\autore}{Giuseppe Ganci}                 % Autore tesi
\newcommand{\relatore}{Prof. Marco Morana}           % Relatore
\newcommand{\correlatore}{?}               % Correlatore
\newcommand{\controrelatore}{Prof. ?}   % Controrelatore
...
\newcommand{\titolotesi}{%                                   % Titolo della tesi
  \uppercase{Tecniche di AML per la generazione di attacchi query efficient}}
...
\newcommand{\mybindingoffset}{1.5cm}                 % Offset rilegatura
...
{%
\fancyhf{}%
\fancyfoot[C]{\large{Anno Accademico 2022/2023}}%
