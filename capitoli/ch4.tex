...
\begin{itemize}
    ...
    \item \textbf{Valutazione della Funzione Obbiettivo}: viene utilizzato per calcolare l'accuratezza della \textit{subnet}, coinvolta nel calcolo della funzione obbiettivo del processo di ricerca.
\end{itemize}
...
\addlinespace
\textbf{Pruned}  & \textbf{15.93 \textcolor{darkgray}{(-26.6\%)}}       & \textbf{89.59\% \textcolor{darkgray}{(-0.83\%)}}         & \textbf{6.85 \textcolor{darkgray}{(-25.51\%)}}   & \textbf{1405.5 \textcolor{darkgray}{(+23.56\%)}}             & \textbf{91.1 \textcolor{darkgray}{(-19.07\%)}}               \\ \bottomrule
\end{tabular}
\end{table}
