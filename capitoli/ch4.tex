...
\begin{table}[ht]
    ...
    \begin{tabular}{@{} l r r r r r @{}}
        ...
        Baseline           & 21.67 \hphantom{(-00.0\%)}        & 90.42\% \hphantom{(-0.00\%)}        & 9.20 \hphantom{(-00.00\%)}        & 1137.5 \hphantom{(+00.00\%)}        & 112.5 \hphantom{(-00.00\%)}       \\
        \midrule
        \textbf{Pruned}    & 15.93 (-26.6\%) & 89.59\% (-0.83\%) & 6.85 (-25.51\%) & 1405.5 (+23.56\%) & 91.1 (-19.02\%) \\
        \midrule
        \textbf{Pruned+KD} & 15.78 (-27.3\%) & 89.86\% (-0.56\%) & 6.79 (-26.19\%) & 1406.0 (+23.60\%) & 91.0 (-19.11\%) \\
        \bottomrule
    \end{tabular}
    \vspace{10pt}
...
\begin{table}[ht]
    ...
    \begin{tabular}{@{} l r r r r r @{}}
        ...
        Baseline           & 21.67 \hphantom{(-00.0\%)}        & 90.42\% \hphantom{(-0.00\%)}        & 9.20 \hphantom{(-00.00\%)}        & 1137.5 \hphantom{(+00.00\%)}        & 112.5 \hphantom{(-00.00\%)}       \\
        \midrule
        \textbf{ViT-S Pruned (No KD)}    & 15.93 (-26.6\%) & 89.59\% (-0.83\%) & 6.85 (-25.51\%) & 1405.5 (+23.56\%) & 91.1 (-19.02\%) \\
        \midrule
        \textbf{Ricerca Disattivata} & 12.28 (-43.4\%) & 81.17\% (-9.25\%) & 5.27 (-42.66\%) & 1679.9 (+47.68\%) & 76.2 (-32.27\%) \\
        \midrule
        \textbf{Metrica Disattivata} & 19.38 (-10.7\%) & 89.07\% (-1.35\%) & 8.18 (-11.09\%) & 1147.9 (+00.09\%) & 111.5 (-00.09\%) \\
        \bottomrule
    \end{tabular}
    \vspace{10pt}
