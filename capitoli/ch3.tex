...
\begin{algorithmic}[1]
    ...
    \For{$n \gets 1$ \textbf{to} $N$}
        ...
        \State $m_{pruning} \gets \text{pruning\_NAS}(M, \mathcal{D}_{search})$ \Comment{NAS to obtain pruning mask}
...
In questa sezione viene dettagliata l'implementazione della fase di ricerca con algoritmo \textit{Branch and Bound}, che viene eseguito all'inizio di ogni iterazione di compressione. \newline
\begin{algorithm}[H]
\caption{Ricerca NAS via Depth-First Branch and Bound a profondità limitata}
